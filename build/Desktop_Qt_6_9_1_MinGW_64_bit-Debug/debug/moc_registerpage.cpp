...
void RegisterPage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (RegisterPage::*)()>(_a, &RegisterPage::registrationSuccessful, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (RegisterPage::*)()>(_a, &RegisterPage::loginRequested, 1))
            return;
    }
}
...
// SIGNAL 0
void RegisterPage::registrationSuccessful()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void RegisterPage::loginRequested()
{
